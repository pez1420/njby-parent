                    ...
                    <div class="panel-body">
                        <form class="form-horizontal" id="inputForm" action="update.jhtml" method="post" role="form">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-8 col-sm-8">
                                    <input class="form-control" name="title" type="text" placeholder="标题"  value="${culture.title}">
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-8 col-sm-8">
                                    <input class="form-control" name="icon" type="text" placeholder="图标" value="${culture.icon}">
                                </div>
                            </div>
