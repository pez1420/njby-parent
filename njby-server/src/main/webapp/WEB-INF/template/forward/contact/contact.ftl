    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-6">
                ...
                <p><span>Email:</span> njby@163.com</p>
...
[#--            <div class="col-md-6">
                ...
                <form class="form-horizontal" id="inputForm" action="save.jhtml" method="post" role="form">
                    <div class="form_details">
                        <input class="text form-control" type="text" name="name" placeholder="名称" style="margin-top: 10px">
                        <input class="text form-control" type="text" name="phone" placeholder="联系电话(手机)" style="margin-top: 10px">
                        <input class="text form-control" type="text" name="title" placeholder="标题" style="margin-top: 10px">
                        <textarea class="form-control" name="content" placeholder="留言详细内容" style="margin-top: 10px"></textarea>
