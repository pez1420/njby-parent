...
/*	@RequestMapping(value = { "/save" }, method = { RequestMethod.POST })
	...
	public String save(Product product, String productTypeId,  
		...
		product.setProductType(this.productTypeService.find(productTypeId));
		product.setSn(UUID.randomUUID().toString());
		this.productService.save(product);
	...
	public String edit(String id, ModelMap model) {
		...
		model.addAttribute("productImages", this.productService.findAllProductImage(product));
...
/*	@RequestMapping(value = { "/update" }, method = { RequestMethod.POST })
	...
	public Message detail(String id) {
		Product product = this.productService.find(id);
		String content = JsonUtil.toJson(product);
